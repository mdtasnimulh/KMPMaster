...
-keepclasseswithmembers public class com.tasnimulhasan.kmpmaster.MainKt {  # <-- Change com.company to yours
...
-keep,includedescriptorclasses class com.tasnimulhasan.kmpmaster.**$$serializer { *; }  # <-- Change com.tasnimulhasan.kmpmaster
-keepclassmembers class com.tasnimulhasan.kmpmaster.** {  # <-- Change com.tasnimulhasan.kmpmaster to yours
    *** Companion;
}
-keepclasseswithmembers class com.tasnimulhasan.kmpmaster.** { # <-- Change com.tasnimulhasan.kmpmaster to yours
    kotlinx.serialization.KSerializer serializer(...);
}
